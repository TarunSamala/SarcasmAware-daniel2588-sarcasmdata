...
BATCH_SIZE = 256
EPOCHS = 30
OUTPUT_DIR = "sarcasm_glove840b_bigru_outputs"  # Changed output directory
...
embeddings = load_glove_pickle(GLOVE_PATH)
...
# Modified Bi-GRU Model
def build_glove840b_bigru_model():  # Renamed function
...
# Training
model = build_glove840b_bigru_model()  # Updated function call
history = model.fit(
...
# Save training curves (same as before)
